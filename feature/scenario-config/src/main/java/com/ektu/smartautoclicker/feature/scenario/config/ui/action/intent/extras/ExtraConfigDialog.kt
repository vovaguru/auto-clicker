 ...
 */
package com.ektu.smartautoclicker.feature.scenario.config.ui.action.intent.extras
...
import com.ektu.smartautoclicker.feature.scenario.config.databinding.DialogConfigActionIntentExtraBinding
...
class ExtraConfigDialog(
    ...
    private fun updateSaveButton(isValidExtra: Boolean) {
        viewBinding.layoutTopBar.setButtonEnabledState(com.ektu.smartautoclicker.core.ui.bindings.DialogNavigationButton.SAVE, isValidExtra)
    }
