 ...
 */
package com.ektu.smartautoclicker.core.ui.overlays.dialog
...
import com.ektu.smartautoclicker.core.ui.databinding.DialogBaseNavBarBinding
import com.ektu.smartautoclicker.core.ui.databinding.IncludeCreateCopyButtonsBinding
import com.ektu.smartautoclicker.core.ui.databinding.IncludeDialogNavigationTopBarBinding
import com.ektu.smartautoclicker.core.ui.databinding.ViewBottomNavBarBinding
...
abstract class NavBarDialogController(
    ...
    /** */
    abstract fun onDialogButtonPressed(buttonType: com.ektu.smartautoclicker.core.ui.bindings.DialogNavigationButton)
    /** */
    ...
    override fun onCreateView(): ViewGroup {
        baseViewBinding = DialogBaseNavBarBinding.inflate(LayoutInflater.from(context)).apply {
            layoutTopBar.apply {
                buttonSave.setOnClickListener { handleButtonClick(com.ektu.smartautoclicker.core.ui.bindings.DialogNavigationButton.SAVE) }
                buttonDismiss.setOnClickListener { handleButtonClick(com.ektu.smartautoclicker.core.ui.bindings.DialogNavigationButton.DISMISS) }
                buttonDelete.setOnClickListener { handleButtonClick(com.ektu.smartautoclicker.core.ui.bindings.DialogNavigationButton.DELETE) }
            }
        }
    ...
    private fun handleButtonClick(buttonType: com.ektu.smartautoclicker.core.ui.bindings.DialogNavigationButton) {
